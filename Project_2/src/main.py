...
from plotters import plot_cholesky, plot_built_in
...
def main():
   ...
   for N_instance in N:
      ...
      _, iterations_steepest_descent = solve_steepest_descent(N_instance)
      ...
      rows.append({
         ...
         'Didžiausio nuolydžio iteracijų skaič.': iterations_steepest_descent,
   ...
   print('Built-in method 1 (solve):', X_results[0])
   print('Built-in method 2 (lu_solve):', X_results[1])
   print('Built-in method 3 (cho_solve):', X_results[2])
   print('Built-in method 4 (fsolve):', X_results[3])
